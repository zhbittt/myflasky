...
class Pagination(object):
    ...
    '''
    def __init__(self,total_count,base_url,max_pager_count=7,per_page_count=10):
        self.request = request
        current_page =self.request.args.get("page","")
        params = copy.deepcopy(self.request.args)
        params = params.to_dict()
        if current_page:
            params.pop("page")
        self.params_urlencode = urlencode(params)
        try:
